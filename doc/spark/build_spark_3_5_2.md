...
##下载源码包
```
https://archive.apache.org/dist/spark/spark-3.5.2/spark-3.5.2.tgz
```

## 在 git bash中编译
```
1.修改$SPARK_HOME/pom.xml文件：删除在repositories标签中的内容 新增阿里云的maven仓库地址和cloudera的仓库地址
<repository>  
	<id>alimaven</id>  
...
1.1删掉<pluginRepositories></pluginRepositories>标签中的内容
...
6.编译：
./dev/make-distribution.sh --name 3.0.0-cdh6.3.1 --tgz -Phadoop-3 -Dhadoop.version=3.0.0-cdh6.3.1 -Pscala-2.12 -Dscala.version=2.12.18 -Phive -Phive-thriftserver -Pyarn

# 编译Spark3.2.4并导入IDEA，在IDEA中运行Spark SQL 对接Hive
```
编译版本信息
spark.version=3.2.4
...
##下载源码包
```
https://archive.apache.org/dist/spark/spark-3.2.4/spark-3.2.4.tgz
```
...
6.编译：
./dev/make-distribution.sh --name 2.7.4 --tgz -Phadoop-2.7 -Dhadoop.version=2.7.4 -Dscala.version=2.12.15 -Phive -Phive-thriftserver -Pyarn
